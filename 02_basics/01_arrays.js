...
// const mArr3 = myArr.slice(1, 3);  // array using slice =, <
// console.log(mArr3);


// console.log("B", myArr);
// const mArr4 = myArr.splice(1, 3); // array using splice =, <=
...
//----------------------- method calling cannot be done on an simple string ---------------------------------------

// convert a simple string to an array

// const newString = "harsh kumar suman";
// console.log(newString);

// const newArrayFromString = Array.from(newString);
// console.log(newArrayFromString);

// // const newArrayUsingSplit = newString.split();
// const newArrayUsingSplit = newString.split("");
// console.log(newArrayUsingSplit)

// // const newStr1 = "harsh";
// // // console.log(Array.from(newStr1));
// // // console.log(newStr1.split(""));

// // // const needToReverseArr = Array.from(newStr1.split(""));
// // const needToReverseArr = Array.from(newStr1);
// // const reverseArr = needToReverseArr.reverse();
// // console.log(reverseArr.join(""))

// const someChar = ["k", "i", "t", "e"];
// console.log(someChar);
// console.log(someChar.join("").toUpperCase());
